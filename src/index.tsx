...
import { ActivityIndicator, Dimensions, FlatList, Image, Keyboard, PixelRatio, Platform, ScrollView, StyleSheet, Text, TextInput, TouchableHighlight, View } from 'react-native';
